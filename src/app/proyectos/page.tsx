...
const projects = [
  ...
  {
    id: "wms-upb",
    title: "WMS UPB - Simulador",
    description: "Laboratorio virtual para la gestión de almacenes. Simulador educativo para prácticas de Warehouse Management System con herramientas de análisis ABC, Layout, EOQ y KPIs logísticos.",
    tags: ["Streamlit", "WMS", "Simulación", "Educación"],
    icon: "W",
    color: "teal",
    demoUrl: "https://wms-upb.streamlit.app",
    features: ["Análisis ABC", "Layout de Almacén", "Gestión de Inventarios", "KPIs Logísticos"]
  },
  {
    id: "plataforma-cedi",
    ...
    icon: "C",
    color: "orange",
    demoUrl: "https://cedi-platform.streamlit.app",
    features: ["Control de Operaciones", "Gestión de Pedidos", "Reportes"]
  },
  {
    id: "historias-narradas-viento",
    title: "Historias Narradas por el Viento",
    description: "Librería digital gótica con novelas gráficas interactivas. Historias inmersivas de fantasía, redención y eternidad, con música original y navegación cinematográfica.",
    tags: ["HTML", "JavaScript", "Narrativa", "Creativo"],
    icon: "H",
    color: "purple",
              ...
              <div key={project.id} className="bg-slate-50 rounded-2xl overflow-hidden hover:shadow-xl transition-shadow border border-slate-100">
                ...
                <div className="p-8">
                  ...
                  <div className="flex gap-4 mt-6">
                    <Link href={project.demoUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-blue-600 font-medium hover:underline">
